      ...
      <form method="post" action="D">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your email" required name="luser">
          </div>
          
          <div class="input-box">
            <span class="details">Enter Password</span>
            <input type="text" placeholder="Enter your password" required name="lpass">
          </div>
...
<a href="forgetPass.jsp"><p style="margin-top: -20px;">Forget Password</p></a>
       <p style="margin-right: 30px">Don't have Account?<a href="Doctor_Reg.jsp">Click here to Register</a></p>
      </form>
    </div>
  </div>
