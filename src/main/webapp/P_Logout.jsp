...
<body>
      ...
      <div style="align-content: center;text-align: center;justify-content: center;">
    ...
    <br><br><br>
  <a href="Patient_Login.jsp"> <button style="background: black;color: white">Back To Login Page</button></a> 
    
    <!-- Redirect to review.jsp after a few seconds -->
    <script>
        setTimeout(function() {
            window.location.href = "Patient_Login.jsp";
        },5000); // Redirect after 20 seconds
    </script>
    </div>
</body>
</html>
