      ...
      <form method="post" action="m">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <div class="input-box">
            <span class="details">Enter Fees</span>
            <input type="text"  name="fees"  placeholder="Enter consult fees" required>
          </div>
          <div class="input-box">
          
           
            <span class="details">Qualification</span>
            <select name="quali" id="cars">
              ...
              <option value="ANATOMY">ANATOMY</option>
               ...
               <option value="MBBS" >GENERAL-MD</option>
            </select>
          </div>
           ...
           <div class="input-box">
            ...
            <input type="text"  name="psw"  placeholder="Enter your Experience" required>
          </div>
