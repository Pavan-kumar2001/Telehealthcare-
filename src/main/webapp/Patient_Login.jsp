...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html><title> TeleHealthCare</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="title">Patient-Login
      
    </div>
   <% 
     String namea="welcome to login ";
      ...
      <form method="post" action="l">
        ...
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" name="luser" placeholder="Enter your email" required>
          </div>
          
          <div class="input-box">
            <span class="details">Enter Password</span>
            <input type="text" name="lpass" placeholder="Enter your password" required>
          </div>
